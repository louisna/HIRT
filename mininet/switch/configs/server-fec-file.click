...
localudpsocket :: Socket(UDP, 130.104.229.10, 51902, 130.104.229.15, 51902, CLIENT true);
...
localudpsocket
    ...
    -> UDPIP6Encap(fc00::1, 51902, fc00::2, 51902)
